...
<div id="mainSlide" class="carousel slide carousel-fade" data-bs-ride="carousel" style="width:40%; margin: auto; display: flex; margin-bottom:40px; margin-top: 100px; border-radius:100px;">
...
<div class="container-xxl d-flex" style="width:820px; margin: auto;">
	...
	<a class="btn" href="#" style="width:170px; height:50px; border-radius: 5px; font-size:15pt; background-color:#558DF0; color:white; padding:10px; margin:7px"><b>수도</b></a>
	<a class="btn" href="#" style="width:170px; height:50px; border-radius: 5px; font-size:15pt; background-color:#558DF0; color:white; padding:10px; margin:7px"><b>상식</b></a>
	<a class="btn" href="#" style="width:170px; height:50px; border-radius: 5px; font-size:15pt; background-color:#558DF0; color:white; padding:10px; margin:7px"><b>넌센스</b></a>
	<a class="btn" href="#" style="width:170px; height:50px; border-radius: 5px; font-size:15pt; background-color:#558DF0; color:white; padding:10px; margin:7px"><b>한국사</b></a>
</div><br>
