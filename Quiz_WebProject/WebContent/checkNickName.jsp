...
<div id="wrap col-12">
	...
	<div id="chk">
		...
		<div class="gap-5 d-md-block align-items-md-center container-xxl">
			...
			<button class="col-3 btn float-right" style="background-color: #558DF0; color:white;" id="cancel" style="margin-left: 10%" type="button" onclick="window.close()">취소</button>
		</div>
	</div>
</div>	
</body>
