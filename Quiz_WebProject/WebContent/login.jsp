...
<form method="post" action="action/loginAction.jsp">
    ...
    <div class="gap-2 d-md-block col-12 d-flex">
        <button class="btn btn col-5" type="button" style="background-color: #FFFFFF"><b>아이디/비밀번호 찾기</b></button>
        <button class="btn btn col-5" type="button" onclick="location.href='signUp.jsp'" style="background-color: #FFFFFF"><b>회원가입</b></button>
    </div>
</form>
</section>
